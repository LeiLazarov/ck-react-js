 ...
 */
 ...
 export default class Sample extends Component {
                 ...
                 { this.state.isLayoutReady && (
                     <CKEditor
                         ...
                         config={ {
                             ...
                             cloudServices: {
                                 tokenUrl: `https://82209.cke-cs.com/token/dev/2f5eff9f99069d84c22eb41b87c2a16a561cf510c2fdc3e2370086bf069c?user.id=${this.getRandomUserId()}&user.name=Name ${this.getRandomName()}&user.avatar=https://randomuser.me/api/portraits/women/${this.getRandomAvatar()}.jpg&role=writer`,
                                 uploadUrl: "https://82209.cke-cs.com/easyimage/upload/",
                                 webSocketUrl: "wss://82209.cke-cs.com/ws"
                             },
                             collaboration: {
                                 channelId: "1pj0bgtncgd"
                             },
                             image: {
                                 toolbar: [
                                     'imageStyle:inline',
     ...
     getRandomAvatar() {
         const avatarId = [30, 51]
         return avatarId[Math.floor(Math.random() * 2)]
     }
 }
